...
- **[API](https://api.ethereum.incubus-network.com/docs/)** - provides a base set of functionality via REST and WebSocket that can be extended with coin specific logic
